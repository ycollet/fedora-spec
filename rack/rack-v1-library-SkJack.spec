...
%global commit0 e494bacb7487df74555a5636b9d67f6176919f57
...
Source0: Rack.tar.gz
Source1: https://github.com/Skrylar/skjack-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SkJack_plugin.json
...
%description
SkJack plugin for Rack.
Four named input and output JACK ports.
...
cp -n %{SOURCE2} SkJack_plugin/plugin.json
...
cp -r SkJack_plugin/dist/SkJack/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SkJack/
