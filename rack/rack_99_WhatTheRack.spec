...
%description
WhatTheRack modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/WhatTheRack/
cp -r WhatTheRack_plugin/dist/WhatTheRack/* %{buildroot}%{_libexecdir}/Rack/plugins/WhatTheRack/
