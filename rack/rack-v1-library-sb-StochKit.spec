...
%global commit0 767383b9eda7b61ea5c8187296c676dd4fcf94fa
...
Name:    rack-v1-sb-StochKit
Version: 1.0.0
Release: 3%{?dist}
Summary: sb-StochKit plugin for Rack
License: GPLv2+
URL:     https://github.com/smbddha/sb-StochKit

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/smbddha/sb-StochKit/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: sb-StochKit_plugin.json
...
cd sb-StochKit_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/sb-StochKit/
cp -r sb-StochKit_plugin/dist/sb-StochKit/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/sb-StochKit/
