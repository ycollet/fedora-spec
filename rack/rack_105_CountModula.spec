...
%global commit0 6a41fba59413d9f0ea704229a87f96ba84903dbc
...
%description
CountModula modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/CountModula/
cp -r CountModula_plugin/dist/CountModula/* %{buildroot}%{_libexecdir}/Rack/plugins/CountModula/
