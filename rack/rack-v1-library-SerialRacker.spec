...
%global commit0 d9ee185945267e124664828a1cffe5dc56da96de
...
Name:    rack-v1-SerialRacker
Version: 0.6.1
Release: 3%{?dist}
Summary: SerialRacker plugin for Rack
License: GPLv2+
URL:     https://github.com/apbianco/SerialRacker

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/apbianco/SerialRacker/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SerialRacker_plugin.json
