...
%global commit0 f0fe2d2eaa9f56f409e28af0949538a4f00e4f68
...
Version: 1.0.0
Release: 3%{?dist}
Summary: CYC plugin for Rack
License: GPLv2+
URL:     https://github.com/mrletourneau/strong_kar

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/mrletourneau/strong_kar/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: CYC_plugin.json
...
mkdir CYC_plugin
tar xvfz %{SOURCE1} --directory=CYC_plugin --strip-components=1 

cp -n %{SOURCE2} CYC_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/CYC/
cp -r CYC_plugin/dist/CYC/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/CYC/
