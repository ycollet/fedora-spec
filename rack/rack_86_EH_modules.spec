...
%description
EH_modules modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/EH_modules/
cp -r EH_modules_plugin/dist/EH_modules/* %{buildroot}%{_libexecdir}/Rack/plugins/EH_modules/
