...
%global commit0 9e074851828aa99ce85cbe1fedb02fb8485d9917
...
License: GPLv2+
URL:     https://github.com/david-c14/submarine-prototype-vcv
...
Source0: Rack.tar.gz
Source1: https://github.com/david-c14/submarine-prototype-vcv/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
SubmarinePrototype modules for VCV Rack
...
mkdir SubmarinePrototype_plugin
tar xvfz %{SOURCE1} --directory=SubmarinePrototype_plugin --strip-components=1 

%build

cd SubmarinePrototype_plugin
