...
%global commit0 b07a714989ab59189ca19b599a03ab8fabc5679b
...
License: GPLv2+
URL:     https://github.com/bongozone/vcvrack-rtlsdr
...
Source0: Rack.tar.gz
Source1: https://github.com/bongozone/vcvrack-rtlsdr/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
mkdir PulsumQuadratum-SDR_plugin
tar xvfz %{SOURCE1} --directory=PulsumQuadratum-SDR_plugin --strip-components=1 

%build

cd PulsumQuadratum-SDR_plugin
