...
%global commit0 e48113f8f3f736cb76b8f1f33078d754ca37d019
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/cf/
cp -r cf_plugin/dist/cf/* %{buildroot}%{_libexecdir}/Rack/plugins/cf/

%files
%{_libexecdir}/*

%changelog
* Sun Nov 18 2018 Yann Collette <ycollette.nospam@free.fr> - 0.6.8
- initial specfile
