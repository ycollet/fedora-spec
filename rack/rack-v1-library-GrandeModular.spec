...
%global commit0 5500cc1e6129dcf17410ea08467db3bba03b9ee1
...
License: GPLv2+
URL:     https://github.com/dbgrande/GrandeModular

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/dbgrande/GrandeModular/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: GrandeModular_plugin.json
...
mkdir GrandeModular_plugin
tar xvfz %{SOURCE1} --directory=GrandeModular_plugin --strip-components=1 

cp -n %{SOURCE2} GrandeModular_plugin/plugin.json

%build

cd GrandeModular_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/GrandeModular/
cp -r GrandeModular_plugin/dist/GrandeModular/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/GrandeModular/
