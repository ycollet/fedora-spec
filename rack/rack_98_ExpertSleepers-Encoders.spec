...
%description
ExpertSleepers-Encoders modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/ExpertSleepers-Encoders/
cp -r ExpertSleepers-Encoders_plugin/dist/ExpertSleepers-Encoders/* %{buildroot}%{_libexecdir}/Rack/plugins/ExpertSleepers-Encoders/
