...
%global commit0 e9a6569a1460263c78f774cb9cfb352152263b54
...
Name:    rack-v1-com-soundchasing-stochasm
Version: 0.6.0
Release: 3%{?dist}
...
Source0: Rack.tar.gz
Source1: https://github.com/teletypist/stochasm/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: com-soundchasing-stochasm_plugin.json
...
%description
com-soundchasing-stochasm plugin for Rack.
...
cd com-soundchasing-stochasm_plugin
%make_build RACK_DIR=.. PREFIX=/usr LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/com-soundchasing-stochasm/
cp -r com-soundchasing-stochasm_plugin/dist/com-soundchasing-stochasm/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/com-soundchasing-stochasm/
