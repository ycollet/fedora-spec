...
%global commit0 c5ed11c4ea3e012c9d2aa3950b96acbb33356527
...
Source0: Rack.tar.gz
Source1: https://github.com/giogramegna/mantra-master/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Mantra_plugin.json
...
%description
Mantra plugin for Rack.
Dual amplifier with up to X3 Gain
...
mkdir Mantra_plugin
tar xvfz %{SOURCE1} --directory=Mantra_plugin --strip-components=1 

cp -n %{SOURCE2} Mantra_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Mantra/
cp -r Mantra_plugin/dist/Mantra/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Mantra/
