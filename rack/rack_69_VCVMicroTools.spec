...
%global commit0 ca439d6468dc8aa3f57e8215da931f37a490b957
...
License: GPLv2+
URL:     https://github.com/a2aaron/VCVMicroTools
...
Source0: Rack.tar.gz
Source1: https://github.com/a2aaron/VCVMicroTools/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
Aaron-MicroTools modules for VCV Rack
...
mkdir Aaron-MicroTools_plugin
tar xvfz %{SOURCE1} --directory=Aaron-MicroTools_plugin --strip-components=1 

%build

cd Aaron-MicroTools_plugin

sed -i -e '9,25d' Makefile
