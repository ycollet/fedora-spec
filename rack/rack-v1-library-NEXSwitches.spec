...
%global commit0 6714d7933fc588ae4a395139827b80ed33332f8d
...
Source0: Rack.tar.gz
Source1: https://github.com/lkdjiin/SwitchesModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: NEXSwitches_plugin.json
...
%description
NEXSwitches plugin for Rack.
Mute two channels at once with fades
...
mkdir NEXSwitches_plugin
tar xvfz %{SOURCE1} --directory=NEXSwitches_plugin --strip-components=1 

cp -n %{SOURCE2} NEXSwitches_plugin/plugin.json

%build

cd NEXSwitches_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/NEXSwitches/
cp -r NEXSwitches_plugin/dist/NEXSwitches/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/NEXSwitches/
