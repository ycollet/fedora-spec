...
%global commit0 2b695859d67fee27fa02383f84004a5dba786f23
%global gittag0 v0.6
...
Version: 0.6.0
Release: 2%{?dist}
Summary: A VST bridge for Rack

Group:   Applications/Multimedia
License: GPLv2+
URL:     https://github.com/VCVRack/Bridge
...
mkdir bridge_plugin
tar xvfz %{SOURCE1} --directory=bridge_plugin --strip-components=1 

tar xvfj %{SOURCE2}

%build

cd bridge_plugin/VST

make RACK_DIR=../.. VST2_SDK=../../vst/vstsdk2.4 DESTDIR=%{buildroot} PREFIX=/usr LIBDIR=%{_lib} %{?_smp_mflags} dist
...
cp dist/VCV-Bridge.so %{buildroot}%{_libdir}/vst/

%files
%{_libdir}/vst/*

%changelog
* Sun Nov 18 2018 Yann Collette <ycollette.nospam@free.fr> - 0.6
- initial specfile
