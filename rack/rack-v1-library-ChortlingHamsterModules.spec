...
Source2: ChortlingHamsterModules_plugin.json
...
%description
ChortlingHamsterModules plugin for Rack.
...
mkdir ChortlingHamsterModules_plugin
tar xvfz %{SOURCE1} --directory=ChortlingHamsterModules_plugin --strip-components=1 

cp -n %{SOURCE2} ChortlingHamsterModules_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ChortlingHamsterModules/
cp -r ChortlingHamsterModules_plugin/dist/ChortlingHamsterModules/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ChortlingHamsterModules/
