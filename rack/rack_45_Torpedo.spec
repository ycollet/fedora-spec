...
%global commit0 df476affa2670ed24487dca1037ebf421f003f26
...
License: GPLv2+
URL:     https://github.com/david-c14/Torpedo
...
Source0: Rack.tar.gz
Source1: https://github.com/david-c14/Torpedo/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
TorpedoDemo modules for VCV Rack
...
mkdir TorpedoDemo_plugin
tar xvfz %{SOURCE1} --directory=TorpedoDemo_plugin --strip-components=1 

%build

cd TorpedoDemo_plugin
