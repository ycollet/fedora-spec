...
%description
NocturnalEncoder modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/NocturnalEncoder/
cp -r NocturnalEncoder_plugin/dist/NocturnalEncoder/* %{buildroot}%{_libexecdir}/Rack/plugins/NocturnalEncoder/
