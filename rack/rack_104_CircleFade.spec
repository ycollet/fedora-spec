...
%global commit0 8cf230a2575c92a8a07d303526a5a8adac6f5042
...
%description
Circlefade modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/Circlefade/
cp -r Circlefade_plugin/dist/Circlefade/* %{buildroot}%{_libexecdir}/Rack/plugins/Circlefade/
