...
%global commit0 482fe31b5a568be6729477383283eaddc3fd67dc
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/21kHz/
cp -r 21kHz_plugin/dist/21kHz/* %{buildroot}%{_libexecdir}/Rack/plugins/21kHz/
