...
mkdir NoraCodes_plugin
tar xvfz %{SOURCE1} --directory=NoraCodes_plugin --strip-components=1 

cp -n %{SOURCE2} NoraCodes_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/NoraCodes/
cp -r NoraCodes_plugin/dist/NoraCodes/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/NoraCodes/
