...
%global commit0 b5a6ff0bed29991c1407f4bddc5246ddb5281196
...
Source0: Rack.tar.gz
Source1: https://github.com/dhemery/DHE-Modules//archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: DHE-Modules_plugin.json
...
cd DHE-Modules_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/DHE-Modules/
cp -r DHE-Modules_plugin/dist/DHE-Modules/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/DHE-Modules/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 1.5.1-3
- initial specfile
