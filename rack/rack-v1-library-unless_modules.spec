...
%global commit0 900c5a95c31e211def98607165cd348097906dac
...
%description
unless_modules plugin for Rack.
arcade modulator
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/unless_modules/
cp -r unless_modules_plugin/dist/unless_modules/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/unless_modules/
