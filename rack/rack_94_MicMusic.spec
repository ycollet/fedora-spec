...
%global commit0 68d61330de4a984ad1291fe57024347418687bfc
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/MicMusic/
cp -r MicMusic_plugin/dist/MicMusic/* %{buildroot}%{_libexecdir}/Rack/plugins/MicMusic/
