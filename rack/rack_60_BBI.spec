...
License: GPLv2+
URL:     https://github.com/tnorris/BBI
...
Source0: Rack.tar.gz
Source1: https://github.com/tnorris/BBI/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
tnorris-BostonBrightonModules modules for VCV Rack
...
mkdir tnorris-BostonBrightonModules_plugin
tar xvfz %{SOURCE1} --directory=tnorris-BostonBrightonModules_plugin --strip-components=1 

%build

cd tnorris-BostonBrightonModules_plugin
