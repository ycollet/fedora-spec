...
Name:    rack-v1-scanner-darkly-collection-one
Version: 1.0.1
Release: 3%{?dist}
...
Source0: Rack.tar.gz
Source1: https://github.com/scanner-darkly/vcv-collection-one/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: scanner-darkly-collection-one_plugin.json
...
%description
scanner-darkly-collection-one plugin for Rack.
