...
%global commit0 be6ab554282dc8d60191d96ffa943f7f45c07c44
...
%description
Extratone plugin for Rack.
Adjustable modulo operator for octave-stripping and waveshaping
...
mkdir Extratone_plugin
tar xvfz %{SOURCE1} --directory=Extratone_plugin --strip-components=1 

cp -n %{SOURCE2} Extratone_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Extratone/
cp -r Extratone_plugin/dist/Extratone/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Extratone/
