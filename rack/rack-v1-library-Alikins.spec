...
%global commit0 bd6825081c142319a5c8f27287e1434fd4f45434
...
Create a gate with CV controlled length
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Alikins/
cp -r Alikins_plugin/dist/Alikins/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Alikins/
