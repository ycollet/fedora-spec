...
Source0: Rack.tar.gz
Source1: https://github.com/emurray2/auraaudio-vcv-rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: AuraAudio_plugin.json
...
%description
AuraAudio plugin for Rack.
Visualize sound as weather!
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AuraAudio/
cp -r AuraAudio_plugin/dist/AuraAudio/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AuraAudio/
