...
%global commit0 17f7b134791972c0f37a2c4812f73111ea736072
...
Version: 1.0.0
Release: 3%{?dist}
Summary: s-ol plugin for Rack
License: GPLv2+
URL:     https://git.s-ol.nu/vcvmods
...
%description
s-ol plugin for Rack.
compares a voltage against a window in a circular space
...
cp -n %{SOURCE2} s-ol_plugin/plugin.json
