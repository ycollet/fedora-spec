...
%global commit0 7a8489871c265f90daf791ea65989e12dffc66a7
...
%description
ModularFungi modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/ModularFungi/
cp -r ModularFungi_plugin/dist/ModularFungi/* %{buildroot}%{_libexecdir}/Rack/plugins/ModularFungi/
