...
%global commit0 66adcd0e27d98aa5d328e00007ab47901edf3fed
...
%description
ParableInstruments modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/ParableInstruments/
cp -r ParableInstruments_plugin/dist/ArableInstruments/* %{buildroot}%{_libexecdir}/Rack/plugins/ParableInstruments/
