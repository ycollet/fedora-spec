...
%global commit0 2d33e97d2e344d2926548a0b9f11f1c15ee4ca3c
...
Source0: Rack.tar.gz
Source1: https://github.com/IohannRabeson/VCVRack-Simple/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
IO-Simple modules for VCV Rack
...
mkdir IO-Simple_plugin
tar xvfz %{SOURCE1} --directory=IO-Simple_plugin --strip-components=1 
