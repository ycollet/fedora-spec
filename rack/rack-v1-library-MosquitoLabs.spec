...
%global commit0 15c36b4618668905cfd4e05ca3de0ff831c1c851
...
Name:    rack-v1-MosquitoLabs
Version: 1.1.1
Release: 3%{?dist}
Summary: MosquitoLabs plugin for Rack
License: GPLv2+
URL:     https://github.com/rmosquito/vcv-mosquito/

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/rmosquito/vcv-mosquito//archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: MosquitoLabs_plugin.json
...
%description
MosquitoLabs plugin for Rack.
8-bit wavetable oscillator based on C. Roads' Pulsar Synthesis model.
...
cd MosquitoLabs_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MosquitoLabs/
cp -r MosquitoLabs_plugin/dist/MosquitoLabs/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MosquitoLabs/
