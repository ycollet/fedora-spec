...
%global commit0 2a48ac03f84b98044d47ff88673c9dd7d99f3ad9
%global gittag0 1.0.17
...
Source0: Rack.tar.gz
Source1: https://github.com/squinkylabs/SquinkyVCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: squinkylabs-plug1_plugin.json
...
%description
squinkylabs-plug1 plugin for Rack.
Triple VCO with even waveform
...
cd squinkylabs-plug1_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/squinkylabs-plug1/
cp -r squinkylabs-plug1_plugin/dist/squinkylabs-plug1/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/squinkylabs-plug1/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 1.0.17-3
- initial specfile
