...
%global commit0 cca69215d807b3736a7601d3bce15c69f03331e4
...
Generates a voltage offset based on the knob position.
...
cd SignalFlux_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SignalFlux/
cp -r SignalFlux_plugin/dist/SignalFlux/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SignalFlux/
