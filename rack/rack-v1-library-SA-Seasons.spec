...
%global commit0 7c412675ae614c128a604ce671466052991120cf
...
Name:    rack-v1-SA-Seasons
Version: 1.0.0
Release: 3%{?dist}
Summary: SA-Seasons plugin for Rack
License: GPLv2+
...
mkdir SA-Seasons_plugin
tar xvfz %{SOURCE1} --directory=SA-Seasons_plugin --strip-components=1 

cp -n %{SOURCE2} SA-Seasons_plugin/plugin.json

%build

cd SA-Seasons_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SA-Seasons/
cp -r SA-Seasons_plugin/dist/SA-Seasons/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SA-Seasons/
