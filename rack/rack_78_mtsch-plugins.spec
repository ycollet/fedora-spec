...
%description
mtsch-plugins modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/mtsch-plugins/
cp -r mtsch-plugins_plugin/dist/mtsch-plugins/* %{buildroot}%{_libexecdir}/Rack/plugins/mtsch-plugins/
