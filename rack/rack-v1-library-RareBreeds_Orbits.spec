...
%global commit0 b14a55e2c3079aa29a27bdface1335b002503b33
...
Source0: Rack.tar.gz
Source1: https://github.com/RareBreeds/Orbits/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: RareBreeds_Orbits_plugin.json
...
%description
RareBreeds_Orbits plugin for Rack.
...
cd RareBreeds_Orbits_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/RareBreeds_Orbits/
cp -r RareBreeds_Orbits_plugin/dist/RareBreeds_Orbits/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/RareBreeds_Orbits/
