...
%global commit0 be301f62dd87aae06471b4949f866c916760957a
...
Source0: Rack.tar.gz
Source1: https://github.com/travisat/Truly/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Truly_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Truly/
cp -r Truly_plugin/dist/Truly/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Truly/
