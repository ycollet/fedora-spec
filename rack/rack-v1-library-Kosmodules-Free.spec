...
Source0: Rack.tar.gz
Source1: https://github.com/calvinkosmatka/Kosmodules-Free/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Kosmodules-Free_plugin.json
...
%description
Kosmodules-Free plugin for Rack.
Offset Scale Fold
...
mkdir Kosmodules-Free_plugin
tar xvfz %{SOURCE1} --directory=Kosmodules-Free_plugin --strip-components=1 

cp -n %{SOURCE2} Kosmodules-Free_plugin/plugin.json

%build

cd Kosmodules-Free_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Kosmodules-Free/
cp -r Kosmodules-Free_plugin/dist/Kosmodules-Free/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Kosmodules-Free/
