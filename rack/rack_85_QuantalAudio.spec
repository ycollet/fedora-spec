...
%description
QuantalAudio modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/QuantalAudio/
cp -r QuantalAudio_plugin/dist/QuantalAudio/* %{buildroot}%{_libexecdir}/Rack/plugins/QuantalAudio/
