...
%global commit0 af58b359be3097a316e757859a845df883ae9c0e
...
%description
HolonicSystems-Free modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/HolonicSystems-Free/
cp -r HolonicSystems-Free_plugin/dist/HolonicSystems-Free/* %{buildroot}%{_libexecdir}/Rack/plugins/HolonicSystems-Free/

%files
%{_libexecdir}/*

%changelog
* Sat Nov 30 2019 Yann Collette <ycollette.nospam@free.fr> - 0.6.7
- update to 0.6.7
