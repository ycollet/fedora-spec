...
%global commit0 c3fae384d8affb80c6e43b13252677631e608c36
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/noobhour/
cp -r noobhour_plugin/dist/noobhour/* %{buildroot}%{_libexecdir}/Rack/plugins/noobhour/
