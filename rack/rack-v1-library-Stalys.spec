...
%global commit0 0d2a2f64c7fd53c8685f3a87c2fb9048e3551aee
...
License: GPLv2+
URL:     https://github.com/denischevalier/StalysVCVPlugin

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/denischevalier/StalysVCVPlugin/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Stalys_plugin.json
...
mkdir Stalys_plugin
tar xvfz %{SOURCE1} --directory=Stalys_plugin --strip-components=1 

cp -n %{SOURCE2} Stalys_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Stalys/
cp -r Stalys_plugin/dist/Stalys/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Stalys/
