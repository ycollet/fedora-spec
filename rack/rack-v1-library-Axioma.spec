...
%global commit0 00c6f6c7fe9b7bbfe65f2e7557b4da47c80d34d2
...
Source0: Rack.tar.gz
Source1: https://github.com/kauewerner/Axioma/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Axioma_plugin.json
...
mkdir Axioma_plugin
tar xvfz %{SOURCE1} --directory=Axioma_plugin --strip-components=1 

cp -n %{SOURCE2} Axioma_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Axioma/
cp -r Axioma_plugin/dist/Axioma/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Axioma/
