...
%global commit0 8160f0076653dd084c90b90d58857cda6bdd80ec
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/mental/
cp -r mental_plugin/dist/mental/* %{buildroot}%{_libexecdir}/Rack/plugins/mental/
