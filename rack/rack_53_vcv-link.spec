...
License: GPLv2+
URL:     https://github.com/stellare-modular/vcv-link
...
%description
StellareModular-Link modules for VCV Rack
...
mkdir StellareModular-Link_plugin
tar xvfz %{SOURCE1} --directory=StellareModular-Link_plugin --strip-components=1 

%build

cd StellareModular-Link_plugin
