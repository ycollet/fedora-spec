...
%description
Quadraphonics modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/Quadraphonics/
cp -r Quadraphonics_plugin/dist/Quadraphonics/* %{buildroot}%{_libexecdir}/Rack/plugins/Quadraphonics/
