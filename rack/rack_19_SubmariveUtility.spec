...
%description
SubmarineUtility modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/SubmarineUtility/
cp -r SubmarineUtility_plugin/dist/SubmarineUtility/* %{buildroot}%{_libexecdir}/Rack/plugins/SubmarineUtility/
