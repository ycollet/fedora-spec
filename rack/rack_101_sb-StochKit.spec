...
%global commit0 dbe9bbb18006e891c575db0b019d854b6b6c9c7e
...
%description
sb-StochKit modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/sb-StochKit/
cp -r sb-StochKit_plugin/dist/sb-StochKit/* %{buildroot}%{_libexecdir}/Rack/plugins/sb-StochKit/
