...
%global commit0 92228f4fc7a4dba403ec8f25da1b7db90530f3cb
...
License: GPLv2+
URL:     https://github.com/KieranPringle/CastleRocktronics
...
Source0: Rack.tar.gz
Source1: https://github.com/KieranPringle/CastleRocktronics/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
CastleRocktronics modules for VCV Rack
...
mkdir CastleRocktronics_plugin
tar xvfz %{SOURCE1} --directory=CastleRocktronics_plugin --strip-components=1 

%build

cd CastleRocktronics_plugin

sed -i -e "s/\.\.\/\.\.\/plugin.mk/\.\.\/plugin.mk/g" Makefile
...
%changelog
* Sun Nov 18 2018 Yann Collette <ycollette.nospam@free.fr> - 0.5.0
- initial specfile
