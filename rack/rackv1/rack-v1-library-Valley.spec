...
%global commit0 f970aa457cb9a6d00a50109213be046a03fff86b
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Valley/
cp -r Valley_plugin/dist/Valley/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Valley/
