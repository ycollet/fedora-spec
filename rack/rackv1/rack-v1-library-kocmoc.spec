...
%global commit0 221d8516418403c05eb2d430c917db3b653d9727

%global gittag0 1.2.5
...
Source0: Rack.tar.gz
Source1: https://github.com/janne808/kocmoc-rack-modules//archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: kocmoc_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/kocmoc/
cp -r kocmoc_plugin/dist/kocmoc/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/kocmoc/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 1.2.5-3
- initial specfile
