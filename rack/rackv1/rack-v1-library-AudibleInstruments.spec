...
%global commit0 d5739b8f57598f8178465024000cd99943972eac
...
Source0: Rack.tar.gz
Source1: https://github.com/VCVRack/AudibleInstruments/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
cp -n %{SOURCE2} AudibleInstruments_plugin/plugin.json
