...
%global commit0 15f0075418ce90b67a8d758527fab14dce81ca84
...
License: GPLv2+
URL:     https://github.com/philippesalembier/SckitamVCV
...
Source0: Rack.tar.gz
Source1: https://github.com/philippesalembier/SckitamVCV/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Sckitam_plugin.json
...
mkdir Sckitam_plugin
tar xvfz %{SOURCE1} --directory=Sckitam_plugin --strip-components=1 

cp -n %{SOURCE2} Sckitam_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Sckitam/
cp -r Sckitam_plugin/dist/Sckitam/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Sckitam/
