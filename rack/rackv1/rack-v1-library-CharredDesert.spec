...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/CharredDesert/
cp -r CharredDesert_plugin/dist/CharredDesert/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/CharredDesert/
