...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SynthKit/
cp -r SynthKit_plugin/dist/SynthKit/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SynthKit/
