...
%global commit0 6d119a54cb6e7b70b637265759ebff3b175464ce
...
Name:    rack-v1-wiqid-anomalies
Version: 1.1.0
Release: 3%{?dist}
Summary: wiqid-anomalies plugin for Rack
License: GPLv2+
URL:     https://github.com/wiqid/anomalies

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/wiqid/anomalies/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: wiqid-anomalies_plugin.json
...
%description
wiqid-anomalies plugin for Rack.
