...
Source0: Rack.tar.gz
Source1: https://github.com/raincheque/qwelk/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Qwelk_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Qwelk/
cp -r Qwelk_plugin/dist/Qwelk/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Qwelk/
