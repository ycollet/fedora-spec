...
%global commit0 88d59679d8313d55412ab3e3fd786044e2c64dd0
...
Source0: Rack.tar.gz
Source1: https://github.com/8Mode/8Mode-VCV_Modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: 8Mode_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/8Mode/
cp -r 8Mode_plugin/dist/8Mode/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/8Mode/
