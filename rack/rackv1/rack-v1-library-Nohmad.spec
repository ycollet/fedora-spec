...
cp -n %{SOURCE2} Nohmad_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Nohmad/
cp -r Nohmad_plugin/dist/Nohmad/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Nohmad/
