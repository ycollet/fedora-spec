...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SLUGNAME/
cp -r SLUGNAME_plugin/dist/SLUGNAME/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SLUGNAME/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - VERSION-3
- initial specfile
