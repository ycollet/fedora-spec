...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AuntyLangtonsFree/
cp -r AuntyLangtonsFree_plugin/dist/AuntyLangtonsFree/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AuntyLangtonsFree/
