...
%global commit0 b2662b5e6f903dc70935f3ce8ba42aa92cf89472
...
Version: 1.1.0
Release: 3%{?dist}
Summary: pfzzz plugin for Rack

License: GPLv2+
URL:     https://github.com/pfzzz/rack-plugin
...
Source0: Rack.tar.gz
Source1: https://github.com/pfzzz/rack-plugin/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: pfzzz_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/pfzzz/
cp -r pfzzz_plugin/dist/pfzzz/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/pfzzz/
