...
%global commit0 03a07ee2efc1e03e6ebfd63447e8deed0adcf360
...
Name:    rack-v1-ArableInstruments
Version: 1.0.0
Release: 3%{?dist}
...
Source0: Rack.tar.gz
Source1: https://github.com/adbrant/ArableInstruments.git/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
cd ArableInstruments_plugin
make RACK_DIR=.. DESTDIR=%{buildroot} PREFIX=/usr LIBDIR=%{_lib} %{?_smp_mflags} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ArableInstruments/
cp -r ArableInstruments_plugin/dist/ArableInstruments/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ArableInstruments/
