...
%global commit0 a8cb840d22fc1e0028b01473bd02e3f4aaa3148f
...
cp -n %{SOURCE2} AS_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AS/
cp -r AS_plugin/dist/AS/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/AS/
