...
Source0: Rack.tar.gz
Source1: https://github.com/JTriggerFish/TriggerFish-VCV.git/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: TriggerFish-Elements_plugin.json
...
%description
TriggerFish-Elements plugin for Rack.
...
cd TriggerFish-Elements_plugin
make RACK_DIR=.. DESTDIR=%{buildroot} PREFIX=/usr LIBDIR=%{_lib} %{?_smp_mflags} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/TriggerFish-Elements/
cp -r TriggerFish-Elements_plugin/dist/TriggerFish-Elements/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/TriggerFish-Elements/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 0.6.4-3
- initial specfile
