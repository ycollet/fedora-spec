...
cd MockbaModular_plugin
%make_build RACK_DIR=.. PREFIX=/usr LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MockbaModular/
cp -r MockbaModular_plugin/dist/MockbaModular/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MockbaModular/
