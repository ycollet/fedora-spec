...
%global commit0 c5bef088538611cf2c43f6b3404c2455cd824e2c
...
License: GPLv2+
URL:     https://github.com/Xenakios/Atelier
...
Source0: Rack.tar.gz
Source1: https://github.com/Xenakios/Atelier/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Atelier_plugin.json
...
mkdir Atelier_plugin
tar xvfz %{SOURCE1} --directory=Atelier_plugin --strip-components=1 

cp -n %{SOURCE2} Atelier_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Atelier/
cp -r Atelier_plugin/dist/Atelier/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Atelier/
