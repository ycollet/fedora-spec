...
%global commit0 f9f6cab51dd1e290cf28d7bdc0932ecf466e722d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Bark/
cp -r Bark_plugin/dist/Bark/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Bark/
