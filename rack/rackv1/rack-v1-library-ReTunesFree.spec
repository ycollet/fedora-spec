...
%global commit0 66343c5ceaf1fd07b2b06617135f8cdc9c245d87
...
Name:    rack-v1-ReTunesFree
Version: 1.0.0
Release: 3%{?dist}
Summary: ReTunesFree plugin for Rack

Group:   Applications/Multimedia
License: GPLv2+
URL:     https://github.com/DominoMarama/ReTunesFree
...
Source0: Rack.tar.gz
Source1: https://github.com/DominoMarama/ReTunesFree/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: ReTunesFree_plugin.json
...
mkdir ReTunesFree_plugin
tar xvfz %{SOURCE1} --directory=ReTunesFree_plugin --strip-components=1 

cp -n %{SOURCE2} ReTunesFree_plugin/plugin.json

%build

cd ReTunesFree_plugin
make RACK_DIR=.. DESTDIR=%{buildroot} PREFIX=/usr LIBDIR=%{_lib} %{?_smp_mflags} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ReTunesFree/
cp -r ReTunesFree_plugin/dist/ReTunesFree/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/ReTunesFree/
