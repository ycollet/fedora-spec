...
%global commit0 34094a5e78048816e608063b45e11a538c0341eb
...
License: GPLv2+
URL:     https://github.com/AmalgamatedHarmonics/Prism

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/AmalgamatedHarmonics/Prism/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Prism_plugin.json
...
mkdir Prism_plugin
tar xvfz %{SOURCE1} --directory=Prism_plugin --strip-components=1 

cp -n %{SOURCE2} Prism_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Prism/
cp -r Prism_plugin/dist/Prism/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Prism/
