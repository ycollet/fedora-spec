...
%global commit0 f5d96c4b6dea97ca4182dcc2be3bb14292a539ea
...
Source0: Rack.tar.gz
Source1: https://github.com/david-c14/SubmarineFree/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SubmarineFree_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SubmarineFree/
cp -r SubmarineFree_plugin/dist/SubmarineFree/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SubmarineFree/
