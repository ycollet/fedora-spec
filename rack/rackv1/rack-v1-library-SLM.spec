...
%global commit0 d3d69e01ec22f221e82156ada51fb83e5fc3c5a8
...
Source0: Rack.tar.gz
Source1: https://github.com/salvolm84/SLM-vcv-rack/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: SLM_plugin.json
...
mkdir SLM_plugin
tar xvfz %{SOURCE1} --directory=SLM_plugin --strip-components=1 

cp -n %{SOURCE2} SLM_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SLM/
cp -r SLM_plugin/dist/SLM/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/SLM/
