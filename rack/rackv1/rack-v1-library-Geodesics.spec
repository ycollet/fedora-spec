...
Source0: Rack.tar.gz
Source1: https://github.com/MarcBoule/Geodesics//archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Geodesics_plugin.json
...
mkdir Geodesics_plugin
tar xvfz %{SOURCE1} --directory=Geodesics_plugin --strip-components=1 

cp -n %{SOURCE2} Geodesics_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Geodesics/
cp -r Geodesics_plugin/dist/Geodesics/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Geodesics/
