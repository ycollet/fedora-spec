...
%global commit0 f654809874ed79f1b7922ceccce2cc8b560729c7
...
Source0: Rack.tar.gz
Source1: https://github.com/sumpygump/quantal-audio/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: QuantalAudio_plugin.json
...
cd QuantalAudio_plugin
%make_build RACK_DIR=.. PREFIX=/usr LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/QuantalAudio/
cp -r QuantalAudio_plugin/dist/QuantalAudio/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/QuantalAudio/
