...
%global commit0 76925a7bea9e2b21feab5fb85c365a877ca5e426

%global gittag0 1.1.35
...
Source0: Rack.tar.gz
Source1: https://github.com/bogaudio/BogaudioModules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Bogaudio_plugin.json
...
mkdir Bogaudio_plugin
tar xvfz %{SOURCE1} --directory=Bogaudio_plugin --strip-components=1 

cp -n %{SOURCE2} Bogaudio_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Bogaudio/
cp -r Bogaudio_plugin/dist/Bogaudio/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Bogaudio/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 1.1.35-3
- initial specfile
