...
%global commit0 168a32e1331f7eb355b1522ae0550186bebba45a
...
Source0: Rack.tar.gz
Source1: https://github.com/The-XOR/RackPlugins/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: TheXOR_plugin.json
...
mkdir TheXOR_plugin
tar xvfz %{SOURCE1} --directory=TheXOR_plugin --strip-components=1 

cp -n %{SOURCE2} TheXOR_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/TheXOR/
cp -r TheXOR_plugin/dist/TheXOR/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/TheXOR/
