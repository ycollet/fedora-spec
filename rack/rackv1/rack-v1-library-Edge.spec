...
%global commit0 3df40239f84253d8142b6bdbb2c071089564cd26
...
Source0: Rack.tar.gz
Source1: https://github.com/Edge-Modules/Edge/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Edge_plugin.json
...
mkdir Edge_plugin
tar xvfz %{SOURCE1} --directory=Edge_plugin --strip-components=1 

cp -n %{SOURCE2} Edge_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Edge/
cp -r Edge_plugin/dist/Edge/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Edge/
