...
%global commit0 93877d5f247894772b2932d31ac54e205b5c45c6
...
Name:    rack-v1-MpSeries
Version: 1.0.1
Release: 3%{?dist}
Summary: MpSeries plugin for Rack

License: GPLv2+
URL:     https://github.com/libermnnn/MpSeries
...
Source0: Rack.tar.gz
Source1: https://github.com/libermnnn/MpSeries/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: MpSeries_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MpSeries/
cp -r MpSeries_plugin/dist/MpSeries/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MpSeries/
