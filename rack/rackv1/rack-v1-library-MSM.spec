...
%global commit0 95288c447f1eaf723ccf907cf06b7225eb9a2c4d
...
Source0: Rack.tar.gz
Source1: https://github.com/netboy3/MSM-vcvrack-plugin/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: MSM_plugin.json
...
mkdir MSM_plugin
tar xvfz %{SOURCE1} --directory=MSM_plugin --strip-components=1 

cp -n %{SOURCE2} MSM_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MSM/
cp -r MSM_plugin/dist/MSM/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MSM/
