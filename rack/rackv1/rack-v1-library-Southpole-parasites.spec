...
Name:    rack-v1-Southpole-parasites
Version: 0.6.0
Release: 3%{?dist}
...
Source2: Southpole-parasites_plugin.json
...
%description
Southpole-parasites plugin for Rack.
...
cp -n %{SOURCE2} Southpole-parasites_plugin/plugin.json
