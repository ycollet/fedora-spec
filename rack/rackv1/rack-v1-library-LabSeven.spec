...
%global commit0 b96fd203fdbe73aa9bd87341f8153ac177ed76c3
...
Name:    rack-v1-LabSeven
Version: 1.0.0
Release: 3%{?dist}
Summary: LabSeven plugin for Rack

Group:   Applications/Multimedia
License: GPLv2+
URL:     https://github.com/LabSevenDevVCVRack/LabSeven_VCVRack_modules
...
Source0: Rack.tar.gz
Source1: https://github.com/LabSevenDevVCVRack/LabSeven_VCVRack_modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: LabSeven_plugin.json
...
cp -n %{SOURCE2} LabSeven_plugin/plugin.json
