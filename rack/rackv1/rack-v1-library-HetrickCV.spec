...
%global commit0 7dc53dccccc03d050eb7fcc2b30f85b8763cce9d
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/HetrickCV/
cp -r HetrickCV_plugin/dist/HetrickCV/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/HetrickCV/
