...
%global commit0 23799131df180d5854056f9c25a55ca194458aa1
...
Source0: Rack.tar.gz
Source1: https://github.com/phdsg/PvC/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: PvC_plugin.json
...
mkdir PvC_plugin
tar xvfz %{SOURCE1} --directory=PvC_plugin --strip-components=1 

cp -n %{SOURCE2} PvC_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/PvC/
cp -r PvC_plugin/dist/PvC/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/PvC/
