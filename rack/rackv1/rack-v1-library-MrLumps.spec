...
Source0: Rack.tar.gz
Source1: https://github.com/djpeterso23662/MrLumps/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: MrLumps_plugin.json
...
mkdir MrLumps_plugin
tar xvfz %{SOURCE1} --directory=MrLumps_plugin --strip-components=1 

cp -n %{SOURCE2} MrLumps_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MrLumps/
cp -r MrLumps_plugin/dist/MrLumps/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/MrLumps/
