...
cp -n %{SOURCE2} alto777_LFSR_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/alto777_LFSR/
cp -r alto777_LFSR_plugin/dist/alto777_LFSR/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/alto777_LFSR/
