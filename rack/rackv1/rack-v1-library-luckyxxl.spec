...
%global commit0 13b76875e980503c1d123edded34a310cb2588a6
...
Source0: Rack.tar.gz
Source1: https://github.com/luckyxxl/vcv_luckyxxl/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: luckyxxl_plugin.json
...
mkdir luckyxxl_plugin
tar xvfz %{SOURCE1} --directory=luckyxxl_plugin --strip-components=1 

cp -n %{SOURCE2} luckyxxl_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/luckyxxl/
cp -r luckyxxl_plugin/dist/luckyxxl/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/luckyxxl/
