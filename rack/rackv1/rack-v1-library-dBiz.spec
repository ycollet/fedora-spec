...
%global commit0 fc298c980c44328e6cec89afd853beffcda1a8a8
...
Source0: Rack.tar.gz
Source1: https://github.com/dBiz/dBiz/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: dBiz_plugin.json
...
mkdir dBiz_plugin
tar xvfz %{SOURCE1} --directory=dBiz_plugin --strip-components=1 

cp -n %{SOURCE2} dBiz_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/dBiz/
cp -r dBiz_plugin/dist/dBiz/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/dBiz/
