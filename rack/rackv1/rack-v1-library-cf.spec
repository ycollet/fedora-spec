...
%global commit0 232c138836fadba03d0d6d03f68a37f132918279
...
Source0: Rack.tar.gz
Source1: https://github.com/cfoulc/cf/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: cf_plugin.json
...
mkdir cf_plugin
tar xvfz %{SOURCE1} --directory=cf_plugin --strip-components=1 

cp -n %{SOURCE2} cf_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/cf/
cp -r cf_plugin/dist/cf/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/cf/
