...
%global commit0 743b7632d53487175c560eb45df2030c1550e112
...
Source0: Rack.tar.gz
Source1: https://github.com/The-Great-Assyr/Chiptuner/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: Chiptuner_plugin.json
...
mkdir Chiptuner_plugin
tar xvfz %{SOURCE1} --directory=Chiptuner_plugin --strip-components=1 

cp -n %{SOURCE2} Chiptuner_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Chiptuner/
cp -r Chiptuner_plugin/dist/Chiptuner/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Chiptuner/
