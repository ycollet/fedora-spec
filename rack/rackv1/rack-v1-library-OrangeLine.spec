...
%global commit0 839e29621e8bde087f69ecd4109e77045fc66c70
...
cp -n %{SOURCE2} OrangeLine_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/OrangeLine/
cp -r OrangeLine_plugin/dist/OrangeLine/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/OrangeLine/
