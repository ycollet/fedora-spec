...
%global commit0 09dd62212006194f398d583cf03c87715689add6
...
cd PG-Instruments_plugin
%make_build RACK_DIR=.. PREFIX=/usr LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/PG-Instruments/
cp -r PG-Instruments_plugin/dist/PG-Instruments/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/PG-Instruments/
