...
%global commit0 231fecd7a3986952c3c42b00ed884524095ed542
...
Source0: Rack.tar.gz
Source1: https://github.com/mschack/VCV-Rack-Plugins/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: mscHack_plugin.json
...
mkdir mscHack_plugin
tar xvfz %{SOURCE1} --directory=mscHack_plugin --strip-components=1 

cp -n %{SOURCE2} mscHack_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mscHack/
cp -r mscHack_plugin/dist/mscHack/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mscHack/
