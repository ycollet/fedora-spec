...
Name:    rack-v1-UnforgettableLuncheon
Version: 0.6.3
Release: 3%{?dist}
...
Source0: Rack.tar.gz
Source1: https://github.com/johnnymurf/Unforgettable-Luncheon.git/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: UnforgettableLuncheon_plugin.json
...
%description
UnforgettableLuncheon plugin for Rack.
...
cp -n %{SOURCE2} UnforgettableLuncheon_plugin/plugin.json
