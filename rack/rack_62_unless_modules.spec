...
%global commit0 784d1e4a181fe785f38001df1bf2a53b62eb57a2
...
License: GPLv2+
URL:     https://github.com/unlessgames/unless_modules.git
...
# find . -name ".git" -exec rm -rf {} \;
# cd ..
# tar cvfz unless_modules.tar.gz unless_modules/*
...
%description
unless_modules modules for VCV Rack
