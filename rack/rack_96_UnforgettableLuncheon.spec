...
Source0: Rack.tar.gz
Source1: https://github.com/johnnymurf/Unforgettable-Luncheon/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
%description
UnforgettableLuncheon modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/UnforgettableLuncheon/
cp -r UnforgettableLuncheon_plugin/dist/UnforgettableLuncheon/* %{buildroot}%{_libexecdir}/Rack/plugins/UnforgettableLuncheon/
