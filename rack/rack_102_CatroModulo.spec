...
%description
CatroModulo modules for VCV Rack
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/CatroModulo/
cp -r CatroModulo_plugin/dist/CatroModulo/* %{buildroot}%{_libexecdir}/Rack/plugins/CatroModulo/
