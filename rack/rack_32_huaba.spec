...
%global commit0 939e1ae42c45d98202fb0913a96d42266b2bad18
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/huaba/
cp -r huaba_plugin/dist/huaba/* %{buildroot}%{_libexecdir}/Rack/plugins/huaba/
