...
%global commit0 3d36fbbaa21590389b41d07fae19a94a6ac4adb7
...
Source0: Rack.tar.gz
Source1: https://github.com/Rcomian/rcm-modules/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/rcm/
cp -r rcm_plugin/dist/rcm/* %{buildroot}%{_libexecdir}/Rack/plugins/rcm/
