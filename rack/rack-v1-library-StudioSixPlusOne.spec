...
%global commit0 93bf73385827c6f406120ecbd87bb9fc625894ae
%global gittag0 1.3
...
mkdir StudioSixPlusOne_plugin
tar xvfz %{SOURCE1} --directory=StudioSixPlusOne_plugin --strip-components=1 

cp -n %{SOURCE2} StudioSixPlusOne_plugin/plugin.json

%build

cd StudioSixPlusOne_plugin
%make_build RACK_DIR=.. PREFIX=/usr STRIP=true LIBDIR=%{_lib} dist

%install 

mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/StudioSixPlusOne/
cp -r StudioSixPlusOne_plugin/dist/StudioSixPlusOne/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/StudioSixPlusOne/

%files
%{_libexecdir}/*

%changelog
* Tue Feb 11 2020 Yann Collette <ycollette.nospam@free.fr> - 1.3-3
- initial specfile
