...
Source0: Rack.tar.gz
Source1: https://github.com/zezic/ZZC/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
...
mkdir -p %{buildroot}%{_libexecdir}/Rack/plugins/ZZC/
cp -r ZZC_plugin/dist/ZZC/* %{buildroot}%{_libexecdir}/Rack/plugins/ZZC/
