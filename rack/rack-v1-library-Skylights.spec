...
%global commit0 04c66539824f8e4b4de4da824f2090470e8494ec
...
%description
Skylights plugin for Rack.
Randomized Sample and Hold, simulates minor analogue drift
...
cp -n %{SOURCE2} Skylights_plugin/plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Skylights/
cp -r Skylights_plugin/dist/Skylights/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/Skylights/
