...
%global commit0 afc425683b5c4f73bcd0622a1e935a9e7ef281a4
...
Version: 1.0.0
Release: 3%{?dist}
Summary: JLmod plugin for Rack
License: GPLv2+
URL:     https://github.com/JoakimLindbom/JLmod

# ./rack-source.sh <tag>
# ./rack-source.sh v1.1.6

Source0: Rack.tar.gz
Source1: https://github.com/JoakimLindbom/JLmod/archive/%{commit0}.tar.gz#/%{name}-%{shortcommit0}.tar.gz
Source2: JLmod_plugin.json
...
%description
JLmod plugin for Rack.
Debugger for Ratchets module
...
cp -n %{SOURCE2} JLmod_plugin/plugin.json
