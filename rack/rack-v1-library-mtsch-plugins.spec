...
Source2: mtsch-plugins_plugin.json
...
mkdir -p %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mtsch-plugins/
cp -r mtsch-plugins_plugin/dist/mtsch-plugins/* %{buildroot}%{_libexecdir}/Rack1/plugins-v1/mtsch-plugins/
