...
export LD_PATH          = /usr/lib:/lib:/usr/lib
endif

ifeq ($(BUILD_PROFILE),x86_64)
export CC_ARCH          = -m64
export LD_ARCH          = -m elf_x86_64
export LD_PATH          = /usr/lib:/lib:/usr/lib64
endif

ifeq ($(BUILD_PROFILE),armv6a)
export CC_ARCH          = -march=armv6-a
export LD_ARCH          = 
export LD_PATH          = /usr/lib64:/lib64:/usr/lib64
endif
...
export SO_FLAGS         = $(CC_ARCH) -Wl,--gc-sections -shared -Llibrary -lc -lm -fPIC -lpthread
export MERGE_FLAGS      = $(LD_ARCH) -r
export EXE_FLAGS        = $(CC_ARCH) -Wl,--gc-sections -lm -fPIC -pthread
